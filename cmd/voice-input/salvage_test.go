...
func TestSalvageTail(t *testing.T) {
	cases := []struct {
		...
		{
			name:      "事故复现 09-25:英文边界云端删空格(N→NRO 续写),字面锚点全失配",
			committed: "看一下我现在如果说话的话，如果说的很慢的话就能分辨出来我说的其实是润色。我给我刚才的我刚才给我们的软件加了一个润色的功能，它自己会理解抛弃我说话里边的这个口水词，不要那么多 N",
			final:     "看一下我现在如果说话的话，如果说的很慢的话就能分辨出来我说的其实是润色。我给我刚才的我刚才给我们的软件加了一个润色的功能，它自己会理解抛弃我说话里边的这个口水词不要那么多NRO。",
			wantTail:  "RO。",
			wantOK:    true,
		},
		{
